...
- [x] Commit and push CODEOWNERS through the existing PR path; delivered in adbac28361bf490a5f846e0afb6efa9c84a5ef67 on origin/develop; code-owner enforcement starts when it reaches main.
...
GitHub authentication completed. Active review-only rule 22378749 saved first, then core rule 22368425 updated. Public API and authenticated settings confirm the intended split. CODEOWNERS is committed and pushed to develop; PR #4 proposes delivery to main: https://github.com/waikato-ahuora-smart-energy-systems/OpenUtility/pull/4.
