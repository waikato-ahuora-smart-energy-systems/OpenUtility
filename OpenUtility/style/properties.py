"""Steam-property pseudo-parameter updates for successive STYLE MILP runs."""
...
class CoolPropSteamPropertyProvider:
    ...
    enthalpies are returned in MWh/t to match the STYLE model energy basis.
    """
...
class SteamPropertyUpdateSpec:
    """Property-update inputs extracted after a STYLE MILP solve."""
...
class SteamPropertyUpdate:
    """Updated STYLE data plus the calculated steam-property snapshot."""
...
SuccessiveMilpSolve = Callable[[StyleModelData, int], SteamPropertyUpdateSpec]
...
def apply_steam_property_update(
    ...
    """Return STYLE data with steam pseudo-parameters recalculated from `spec`."""
...
def steam_property_update_spec_from_model(
    ...
    *,
    ...
    """Extract selected steam-property update targets from a solved STYLE model."""
