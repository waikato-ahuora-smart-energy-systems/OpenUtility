"""Adapters from OpenUtility thermal profiles into utility-system model data."""

from __future__ import annotations

from ..thermal import HeatIntervalProfile
from .data import SteamLevelCandidate, UtilitySystemModelData


def utility_system_model_data_from_heat_profile(
...
def utility_system_model_data_from_heat_profile_for_steam_mains(
    profile: HeatIntervalProfile,
    *,
